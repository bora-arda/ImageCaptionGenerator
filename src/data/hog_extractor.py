...
def extract_hog_features(image_path, pixels_per_cell= (8, 8), cells_per_block = (2, 2), orientations = 9, resize_to = (128, 128), multi_channel = False):
    """
    ...
    - resize_to: Tuple indicating the size to resize the image to.
    - multi_channel: Boolean indicating if the image has multiple channels.

    Returns:
    - hog_features: The extracted HOG features as a numpy array.
    """
    ...
    if resize_to is not None:
        gray = resize(gray, resize_to, anti_aliasing=True)
